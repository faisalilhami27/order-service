...
import (
	...
	models "order-service/domain/models/suborder"
...
func (_m *ISubOrderRepository) Create(_a0 context.Context, _a1 *gorm.DB, _a2 *dto.SubOrderRequest) (*models.SubOrder, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 *models.SubOrder
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gorm.DB, *dto.SubOrderRequest) (*models.SubOrder, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *gorm.DB, *dto.SubOrderRequest) *models.SubOrder); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *gorm.DB, *dto.SubOrderRequest) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}
...
type mockConstructorTestingTNewISubOrderRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewISubOrderRepository(t mockConstructorTestingTNewISubOrderRepository) *ISubOrderRepository {
